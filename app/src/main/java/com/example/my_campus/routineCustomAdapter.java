...
public class routineCustomAdapter extends BaseAdapter {
    private Context context;
    private List<String> semesterNames;
    private List<String> pdfUrls;

    public routineCustomAdapter(Context context, List<String> semesterNames, List<String> pdfUrls) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.routine_list_items, parent, false);
        }
